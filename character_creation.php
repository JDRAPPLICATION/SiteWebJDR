<?php 
	...
	if ($_SESSION['n1'] ==  0 && $_SESSION['n2'] == 0) {
...
?>
		<article class="Farticle">
			...
			<form action="character_creation_post.php" method="post">
				<center><label><?php echo $_SESSION['l1'];?></label><select name="l1">          		         																<option value= "Non" > NON-utilisé </option>
				...
				<label><?php echo $_SESSION['l2']?></label><select name="l2">
				...
				<label><?php echo $_SESSION['l3']?></label><select name="l3">
          		         											<option value= "Non" > NON-utilisé </option>
          		         											<option value= "FORC" > FORce </option>
          		         											<option value= "CON" > CONstitution </option>
          		         											<option value= "TAI" > TAIlle </option>
				...
				<label><?php echo $_SESSION['l4']?></label><select name="l4">
          		         											<option value= "Non" > NON-utilisé </option>
          		         											<option value= "FORC" > FORce </option>
          		         											<option value= "CON" > CONstitution </option>
          		         											<option value= "TAI" > TAIlle </option>
				...
				<label><?php echo $_SESSION['l5']?></label><select name="l5">
          		         											<option value= "Non" > NON-utilisé </option>
          		         											<option value= "FORC" > FORce </option>
          		         											<option value= "CON" > CONstitution </option>
          		         											<option value= "TAI" > TAIlle </option>
				...
				<label><?php echo $_SESSION['l6']?></label><select name="l6">
          		         											<option value= "Non" > NON-utilisé </option>
          		         											<option value= "FORC" > FORce </option>
          		         											<option value= "CON" > CONstitution </option>
          		         											<option value= "TAI" > TAIlle </option>
				...
				<label><?php echo $_SESSION['l7']?></label><select name="l7">
          		         											<option value= "Non" > NON-utilisé </option>
          		         											<option value= "FORC" > FORce </option>
          		         											<option value= "CON" > CONstitution </option>
          		         											<option value= "TAI" > TAIlle </option>
          		...
          		<label><?php echo $_SESSION['l8']?></label><select name="l8">
          		         											<option value= "Non" > NON-utilisé </option>
          		         											<option value= "FORC" > FORce </option>
          		         											<option value= "CON" > CONstitution </option>
          		         											<option value= "TAI" > TAIlle </option>
